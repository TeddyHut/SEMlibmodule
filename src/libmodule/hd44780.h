    ...
    namespace userio
    {
        namespace hd
        {
            enum class instr : uint8_t
            {
                ...
                cursor_display_shift, // Moves cursor and shifts display without changing DRAM content;              Accepts 2 parameters.
        ...
        public:
            struct Pin {
                utility::Bidirectional<uint8_t> *data;
                utility::Output<bool> *en, *rw, *rs;
            };
            ...
            // IC_HD44780 &operator<<(void const *const p0);
